<nav class="bg-gradient-to-r from-primary-dark to-primary-light p-[1.2rem_2rem] flex justify-between items-center shadow-[0_2px_8px_rgba(0,0,0,0.1)]" role="navigation" aria-label="Navegación principal">
    <div class="flex items-center gap-4">
        ...
        <a href="{{ route('inicio') }}" class="px-6 py-[0.6rem] {{ $activeRoute === 'inicio' ? 'bg-white text-primary' : 'bg-white/15 text-white' }} border border-white/30 rounded-md cursor-pointer transition-all duration-300 text-[0.9rem] font-medium hover:bg-white/25 hover:-translate-y-px">Inicio</a>
